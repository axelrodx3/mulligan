      ...
      <section className="relative py-16 px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { src: '/testimonial1.png', alt: 'Yelp review - Katie M.' },
              { src: '/testimonial2.png', alt: 'Yelp review - Andrew A.' },
              { src: '/testimonial3.png', alt: 'Yelp review - Jael L.' },
              { src: '/testimonial4.png', alt: 'Yelp review - Diana' },
              { src: '/testimonial5.png', alt: 'Yelp review - Lula R.' },
              { src: '/testimonial6.png', alt: 'Yelp review - T.S.' },
            ].map((t) => (
              <div
                key={t.src}
          ...
          <p className="text-center mt-8">
            <a
              href="https://www.yelp.com/biz/mulligans-sports-bar-and-grille-fort-mill"
              target="_blank"
              rel="noopener noreferrer"
              className="text-mulligan-blue font-medium hover:underline"
            >
